...
export const appRoutes: Route[] = [
    ...
    // Acceuil
    {path: 'acceuil', loadChildren: () => import('app/modules/acceuil/acceuil.module').then(m => m.AcceuilModule)},
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'custom', children: [
                ...
                // Activities
                {path: 'categories', loadChildren: () => import('app/modules/admin/custom/categories/categories.module').then(m => m.CategoriesModule)},

                // Authentication
                {path: 'participants', loadChildren: () => import('app/modules/admin/custom/participants/participants.module').then(m => m.ParticipantsModule)},

                // Personnels
                {path: 'personnels', loadChildren: () => import('app/modules/admin/custom/personnels/personnels.module').then(m => m.PersonnelsModule)},

                // Formation
                {path: 'formations', loadChildren: () => import('app/modules/admin/custom/formations/formations.module').then(m => m.FormationsModule)},

                // Sessions
                {path: 'sessions', loadChildren: () => import('app/modules/admin/custom/sessions/sessions.module').then(m => m.SessionsModule)},
                
                // Messages
                {path: 'messages', loadChildren: () => import('app/modules/admin/custom/messages/messages.module').then(m => m.MessagesModule)},

                 // Messages
                 {path: 'listes', loadChildren: () => import('app/modules/admin/custom/messages/messages.module').then(m => m.MessagesModule)},
                
                // Supports
                {path: 'supports', loadChildren: () => import('app/modules/admin/custom/supports/supports.module').then(m => m.SupportsModule)},
